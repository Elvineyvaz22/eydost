    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <img
              src="https://i.postimg.cc/9WJByvB7/Whats-App-Image-2025-12-11-at-23-51-41.jpg"
              alt="Ey Dost"
              className="h-[45px] object-contain brightness-0 invert mb-3"
            />
          ...
          <div>
            ...
            <div className="text-sm text-gray-400 space-y-2">
              ...
              <p><span className="text-gray-500">{t.footer.vatLabel}:</span> 2901810561</p>
