...
const content = {
  en: {
    ...
    story: [
      ...
      'Alongside eSIM, we expanded into taxi booking across 50+ countries and 850+ cities — anywhere Bolt-style ride-hailing operates. Same idea: no app, no hassle. Just message us on WhatsApp, share your pickup location, and we connect you with a verified local driver.',
    ],
    ...
    values: [
      ...
      { icon: Globe, title: 'Global Reach', desc: '150+ countries for eSIM. 850+ cities across 50+ countries for taxi.' },
      ...
      { icon: Car, title: 'Mobility', desc: 'Reliable rides at your fingertips in 850+ cities worldwide.' },
    ],
  ...
  az: {
    ...
    story: [
      ...
      'eSIM ilə yanaşı, 50+ ölkədə və 850+ şəhərdə taksi sifariş xidmətini əlavə etdik — Bolt və oxşar platformaların işlədiyi hər yerdə. Eyni ideya: proqram yoxdur, çaşqınlıq yoxdur. WhatsApp-da yazın, götürülmə yerini paylaşın — sizi yoxlanılmış yerli sürücü ilə birləşdiririk.',
    ],
    ...
    values: [
      ...
      { icon: Globe, title: 'Qlobal əhatə', desc: 'eSIM üçün 150+ ölkə. Taksi üçün 50+ ölkədə 850+ şəhər.' },
      ...
      { icon: Car, title: 'Mobillik', desc: 'Dünyanın 850+ şəhərində etibarlı taksi xidməti — barmaqlarınızın ucunda.' },
    ],
  ...
  ru: {
    ...
    story: [
      ...
      'Помимо eSIM, мы добавили заказ такси в 50+ странах и 850+ городах — везде, где работают Bolt и подобные сервисы. Та же идея: никаких приложений, никаких хлопот. Напишите в WhatsApp, поделитесь местом посадки — и мы соединим вас с проверенным местным водителем.',
    ],
    ...
    values: [
      ...
      { icon: Globe, title: 'Глобальный охват', desc: '150+ стран для eSIM. 850+ городов в 50+ странах для такси.' },
      ...
      { icon: Car, title: 'Мобильность', desc: 'Надёжные поездки в 850+ городах мира под рукой.' },
    ],
